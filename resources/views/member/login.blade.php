            ...
            <div class="glass-panel relative overflow-hidden rounded-2xl p-6 md:p-8">
                ...
                <div class="relative">
                    ...
                    <div class="mt-10">
                        ...
                        <p class="mt-3 text-sm leading-6 text-muted">Gunakan email atau username dan password dari kasir. Akun hanya aktif selama masa membership masih berlaku.</p>
                    </div>
                    ...
                    <form action="{{ route('member.login.submit') }}" method="POST" class="mt-8 space-y-5">
                        @csrf
                        <div>
                            <label for="email" class="mb-2 block font-mono text-xs uppercase tracking-[0.18em] text-muted">Email / Username Member</label>
                            <div class="glass-field flex items-center gap-3 rounded-xl px-4 transition">
                                ...
                                <input id="email" name="email" type="text" value="{{ old('email') }}" required autofocus placeholder="email atau username dari kasir" class="h-14 min-w-0 flex-1 border-0 bg-transparent px-0 text-white placeholder:text-white/28 focus:ring-0"/>
                            </div>
                        </div>
                    ...
                    <div class="mt-7 border-t border-white/10 pt-5 flex flex-col gap-3">
                        <a href="{{ route('member.activate.show') }}" class="font-mono text-xs uppercase tracking-[0.14em] text-emberSoft hover:text-white transition-colors">

...
{
    /**
     * Legacy route redirect: /verifications -> /receipts
     */
    public function verificationsRedirect(): RedirectResponse
    {
    ...
    /**
     * Display payment receipts list and QRIS verification queue.
     */
    ...
    /**
     * Confirm / verify a QRIS payment.
     */
    public function confirmVerification(Request $request, int $paymentId): RedirectResponse
    {
        if ($redirect = RouteHelpers::ensureCashier()) {
            return $redirect;
        }
     ...
     */
    public function printReceipt(string $invoice): View|RedirectResponse
    {
        if ($redirect = RouteHelpers::ensureCashier()) {
            return $redirect;
        }
